...
class PanelModal {
    ...
    createDOM() {
        ...
        footer.innerHTML = `
            ...
            <div class="panel-modal-footer-item"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg><span>${chrome.i18n.getMessage('xpzmkv')}</span><a href="https://chromewebstore.google.com/detail/fgebdnlceacaiaeikopldglhffljjlhh?utm_source=item-share-cb" target="_blank" class="panel-modal-footer-link">${chrome.i18n.getMessage('pkmzvx')}</a><span> &</span><a href="https://ai.feishu.cn/share/base/form/shrcnm9dxA0OZVK96buotGs1the" target="_blank" class="panel-modal-footer-link">${chrome.i18n.getMessage('fbklink')}</a><span> ❤️</span></div>
